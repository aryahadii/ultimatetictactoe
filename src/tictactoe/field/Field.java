...
public class Field {
     ...
     */
    public void placeDisc(int x, int y, int move) throws Exception {
        if (isPlaceValid(x, y)) {
            throw new Exception(String.format("place (%d, %d) is not valid", x, y));
        }
    ...
    /**
     * Returns reason why placeDisc returns false
     *
     * @return : reason why placeDisc returns false
     */
