...
package com.aryaha.core.game.player;

import java.io.IOException;

import com.aryaha.core.game.commands.ICommand;
import com.aryaha.core.io.IOPlayer;
import com.aryaha.tictactoe.commands.MoveRequestCommand;
...
public abstract class AbstractPlayer {
	...
	public ICommand requestMove() {
		...
		sendMoveRequestCommand();

		ICommand botCommand = null;
		try {
			botCommand = this.bot.getBotCommand(this.timeBank);
	...
	private void sendMoveRequestCommand() {
		MoveRequestMessage requestMsg = new MoveRequestMessage();
		requestMsg.setTimeLimit(this.timeBank);
		sendCommand(new MoveRequestCommand(requestMsg));
	}
